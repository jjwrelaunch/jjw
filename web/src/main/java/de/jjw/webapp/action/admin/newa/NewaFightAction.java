    ...
    implements IGlobalWebConstants
{
    ...
    private static String PARA_FIGHTID = "main:adminNewaFightAction:" + HTML_PARAM_FIGHT;
    ...
    public String save()
    {
        ...
        try
        {
            ...
            sb.append( contextPath ).append( SHOW_NEWACLASS ).append( HTML_QUESTION_MARK ).append( HTML_PARAM_NEWACLASS_ID ).append(
                                                                                                                                             HTML_EQUAL ).append(
