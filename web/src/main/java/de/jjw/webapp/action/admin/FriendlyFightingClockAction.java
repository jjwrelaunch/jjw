 ...
 *
 * File    : FriendlyFightingClockAction.java
 * Created : 05 Jun 2010
...
public class FriendlyFightingClockAction
    extends BasePage
    implements Serializable, IGlobalWebConstants, IAgeConstants
{
    private FriendlyFightManager friendlyFightManager;
    ...
    public FightWeb getFight()
    {
        ...
        if ( getRequest().getAttribute( FIGHT ) == null )
        {
            ...
            {
                fight =
                    friendlyFightManager.getFightForClock( Long.valueOf( getRequest().getParameter( "fightId" ) ),
                                                           getLocale() );
            }
        ...
        {
            return (FightWeb) getRequest().getAttribute( FIGHT );
        }
    }
        ...
        try
        {
            switch ( ConfigMain.getInstance().getEventConfiguration().getLogo() )
            {
                case ConfigJJW.TEAM_LOGO:
                    ...
                    if ( ( (FightWeb) getRequest().getAttribute( FIGHT ) ).getFighterRed().getTeam().getLogo() != null )
                    {
                        sbRed.append( "/image?id=" );
                        sbRed.append( ( (FightWeb) getRequest().getAttribute( FIGHT ) ).getFighterRed().getTeam().getId() );
                    }
                    else
                    {
                        sbRed.append( "/images/country/" );
                        sbRed.append( ( (FightWeb) getRequest().getAttribute( FIGHT ) ).getFighterRed().getTeam().getCountry().getCountryShort() );
                        sbRed.append( ".gif" );
                    }
                ...
                case ConfigJJW.COUNTRY_LOGO:
                    ...
                    sb.append( ( (FightWeb) getRequest().getAttribute( FIGHT ) ).getFighterRed().getTeam().getCountry().getCountryShort() );
                    sb.append( ".gif" );
                    return sb.toString();
            }
        }
        ...
        try
        {
            switch ( ConfigMain.getInstance().getEventConfiguration().getLogo() )
            {
                case ConfigJJW.TEAM_LOGO:
                    ...
                    if ( ( (FightWeb) getRequest().getAttribute( FIGHT ) ).getFighterBlue().getTeam().getLogo() != null )
                    {
                        sbBlue.append( "/image?id=" );
                        sbBlue.append( ( (FightWeb) getRequest().getAttribute( FIGHT ) ).getFighterBlue().getTeam().getId() );
                    }
                    else
                    {
                        sbBlue.append( "/images/country/" );
                        sbBlue.append( ( (FightWeb) getRequest().getAttribute( FIGHT ) ).getFighterBlue().getTeam().getCountry().getCountryShort() );
                        sbBlue.append( ".gif" );
                    }
                ...
                case ConfigJJW.COUNTRY_LOGO:
                    StringBuffer sb = new StringBuffer( 50 );
                    sb.append( "/images/country/" );
                    sb.append( ( (FightWeb) getRequest().getAttribute( FIGHT ) ).getFighterBlue().getTeam().getCountry().getCountryShort() );
                    sb.append( ".gif" );
                    return sb.toString();
            }
        }
