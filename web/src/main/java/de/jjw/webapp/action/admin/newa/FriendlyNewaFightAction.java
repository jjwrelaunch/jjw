...
public class FriendlyNewaFightAction
    extends BasePage
    implements IGlobalWebConstants
{

    private static String PARA_FIGHTID = "main:adminFriendlyNewaFightAction:" + HTML_PARAM_FIGHT;

    private FriendlyNewaFightManager newaFightManager;

    private FriendlyNewaFight fight;
    ...
    public FriendlyNewaFight getFight()
    {
    ...
    public void setNewaFightManager( FriendlyNewaFightManager fightManager )
    {
