...
public class NewaClockAction
    extends BasePage
    implements Serializable, IGlobalWebConstants, IAgeConstants
{
    NewaFightManager newaFightManager;
    ...
    public NewaFightWeb getFight()
    {
        ...
        if ( getRequest().getAttribute( FIGHT ) == null )
        {
            ...
            {
                fight =
                    newaFightManager.getFightForClock( Long.valueOf( getRequest().getParameter( "fightId" ) ),
                                                       getLocale() );
            }
    ...
    /**
     * @param newFightManager The fightManager to set.
     */
    public void setNewaFightManager( NewaFightManager newFightManager )
    {
        this.newaFightManager = newFightManager;
    }
