 ...
 *
 * File    : FriendlyDuoClockAction.java
 * Created : 05 Jun 2010
...
public class FriendlyDuoClockAction
    extends BasePage
    implements Serializable, IGlobalWebConstants, IAgeConstants
{
    FriendlyDuoFightManager friendlyDuoFightManager;
    ...
    public DuoFightWeb getFight()
    {
        ...
        if ( getRequest().getAttribute( FIGHT ) == null )
        {
            ...
            {
                fight =
                    friendlyDuoFightManager.getDuoFightForClock( Long.valueOf( getRequest().getParameter( "fightId" ) ) );
            }
