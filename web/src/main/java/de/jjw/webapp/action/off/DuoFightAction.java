    ...
    implements IGlobalWebConstants
{
    ...
    private static String PARA_FIGHTID = "main:offDuoFightAction:" + HTML_PARAM_FIGHT;
    ...
    public DuoFight getFight()
    {
        ...
        if ( getRequest().getParameter( PARA_FIGHTID ) == null && getRequest().getParameter( HTML_PARAM_FIGHT ) == null )
        {
    ...
    public String save()
    {
        ...
        try
        {
            if ( !userDuoclassManager.isAccessForTatamiUser( getCtx().getUserId(), getFight().getDuoclassId() ) )
            {
            ...
            sb.append( contextPath ).append( SHOW_DUOCLASS_OFFICIAL ).append( HTML_QUESTION_MARK ).append(
                                                                                                           HTML_PARAM_DUOCLASS_ID ).append(
                                                                                                                                            HTML_EQUAL ).append(
                                                                                                                                                                 String.valueOf( getFight().getDuoclassId() ) );
