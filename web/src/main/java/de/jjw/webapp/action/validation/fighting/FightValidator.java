...
import de.jjw.webapp.action.admin.FightAction;
import de.jjw.webapp.action.admin.FriendlyFightAction;
    ...
    implements IFightConstants, IValueConstants, ICodestableConstants
{
    ...
    public static boolean isRequiredFieldsValid( FightAction fightAction, Vector<ErrorElement> errors )
    {
     ...
     * @return
     */
    public static boolean isRequiredFieldsValid( FriendlyFightAction fightAction, Vector<ErrorElement> errors )
    {
        boolean isValid = true;
    ...
    public static boolean isBusinessLogicValid( FightAction fightAction, Vector<ErrorElement> errors )
    {
        boolean isValid = true;
     ...
     * @return
     */
    public static boolean isBusinessLogicValid( FriendlyFightAction fightAction, Vector<ErrorElement> errors )
    {
        boolean isValid = true;
    ...
    public static boolean isRequiredFieldsValid( de.jjw.webapp.action.off.FightAction fightAction,
    ...
    public static boolean isBusinessLogicValid( de.jjw.webapp.action.off.FightAction fightAction,
                                                Vector<ErrorElement> errors )
    {
        boolean isValid = true;
