 ...
 *
 * File    : RegionConverterForNewa.java
 * Created : 05 Jun 2010
...
import de.jjw.webapp.action.admin.newa.NewaFighterAction;

public class RegionConverterForNewa
    extends RegionConverter
{

    public static final String CONVERTER_ID = "jjw.webapp.converter.RegionConverterForNewa";
        ...
        throws ConverterException
    {
        ...
        List regions =
            ( (NewaFighterAction) ( ( (HttpServletRequest) arg0.getExternalContext().getRequest() ).getAttribute(
