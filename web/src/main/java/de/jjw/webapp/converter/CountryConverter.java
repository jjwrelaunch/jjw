...
{
    public static final String CONVERTER_ID = "jjw.webapp.converter.CountryConverter";
        ...
        throws ConverterException
    {
        ...
        while ( it.hasNext() )
        {
            ...
            Country countryFromList = (Country) selItem.getValue();
            ...
            {
                if ( countryFromList.getId().equals( new Long( arg2 ) ) )
                {
        ...
        throws ConverterException
    {
        if ( !TypeUtil.isEmpty( arg2 ) )
        {
            if ( TypeUtil.isEmpty( ( (Country) arg2 ).getId() ) )
            {
                return TypeUtil.STRING_DEFAULT;
            }
            return ( (Country) arg2 ).getId().toString();
        }
        return null;
    }
}
