 ...
 *
 * File    : RegionConverterForDuoTeam.java
 * Created : 05 Jun 2010
...
import de.jjw.webapp.action.admin.DuoTeamAction;
...
public class RegionConverterForDuoTeam
    extends RegionConverter
{

    public static final String CONVERTER_ID = "jjw.webapp.converter.RegionConverterForDuoTeam";
        ...
        throws ConverterException
    {
        ...
        List regions = ( (DuoTeamAction) ( ( (HttpServletRequest) arg0.getExternalContext().getRequest() ).getAttribute(
