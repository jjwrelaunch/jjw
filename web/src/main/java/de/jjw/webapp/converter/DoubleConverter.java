    ...
    implements Converter, ICodestableConstants
{
    ...
    public static final String CONVERTER_ID = "jjw.webapp.converter.DoubleConverter";
        ...
        throws ConverterException
    {
        ...
        try
        {
            return Double.toString( ( (Number) arg2 ).doubleValue() );
        }
        catch ( Exception e )
        {
    ...
    */
    private void setErrorMsg( FacesContext facesContext, UIComponent uiComponent )
    {
        ...
        errors.add( new ErrorElement( uiComponent.getId(), GEN_VALUE_NO_VALID_DECIMAL ) );
