 ...
 *
 * File    : PoolWebComponentHelper.java
 * Created : 16 Jun 2010
...
public class PoolWebComponentHelper
    implements HtmlConstants, IGlobalWebConstants
{
    ...
    public static void doPooltable( UIComponent component, FacesContext context, ResponseWriter out, String tableWidht,
                                    String tableBorder, ResourceBundle rb, List<FightingDoublePoolItem> fighterList )
        throws IOException
    {
    ...
    public static void doPooltableRow( UIComponent component, FacesContext context, ResponseWriter out,
                                       List<FightingDoublePoolItem> fighterList )
        throws IOException
    {
        FightingDoublePoolItem item;
    ...
    public static void doFighttable( UIComponent component, FacesContext context, ResponseWriter out,
                                     ...
                                     Map<Integer, Fight> fightListMap, boolean editAccess, String linkToFight,
                                     int fightNumbering )
        throws IOException
    {
    ...
    public static void doTableCellsLinkFight( UIComponent component, ResponseWriter out, String text, Fight fight,
     ...
     * @throws IOException
     */
    public static void doDuoFighttable( UIComponent component, FacesContext context, ResponseWriter out,
                                        String tableWidht, String tableBorder, ResourceBundle rb,
                                        Map<Integer, DuoFight> fightListMap, boolean editAccess, String linkToFight,
                                        int fightNumbering )
        throws IOException
    {
        int i = fightNumbering;
        ...
        out.writeAttribute( ATTR_CLASS, i % 2 == 0 ? "odd" : "even", null );
        doTableCell( component, out, "18", VAL_CENTER, true, TypeUtil.toString( i - 1 ) );
        doDuoTableCellsLinkFight( component, out, rb.getString( "fightTable.1-2" ), fightListMap.get( 1 ), context,
                                  editAccess,
                                  linkToFight );
        ...
        doTableCell( component, out, "18", VAL_CENTER, true, TypeUtil.toString( i + 4 ) );
        doDuoTableCellsLinkFight( component, out, rb.getString( "fightTable.1-3" ), fightListMap.get( 6 ), context,
                                  editAccess,
                                  linkToFight );
        out.endElement( JSF_TR );
        ...
        out.writeAttribute( ATTR_CLASS, i % 2 == 0 ? "odd" : "even", null );
        doTableCell( component, out, "18", VAL_CENTER, true, TypeUtil.toString( i - 1 ) );
        doDuoTableCellsLinkFight( component, out, rb.getString( "fightTable.3-4" ), fightListMap.get( 2 ), context,
                                  editAccess,
                                  linkToFight );
        ...
        doTableCell( component, out, "18", VAL_CENTER, true, TypeUtil.toString( i + 4 ) );
        doDuoTableCellsLinkFight( component, out, rb.getString( "fightTable.2-4" ), fightListMap.get( 7 ), context,
                                  editAccess,
                                  linkToFight );
        out.endElement( JSF_TR );
        ...
        out.writeAttribute( ATTR_CLASS, i % 2 == 0 ? "odd" : "even", null );
        doTableCell( component, out, "18", VAL_CENTER, true, TypeUtil.toString( i - 1 ) );
        doDuoTableCellsLinkFight( component, out, rb.getString( "fightTable.1-5" ), fightListMap.get( 3 ), context,
                                  editAccess,
                                  linkToFight );
        ...
        doTableCell( component, out, "18", VAL_CENTER, true, TypeUtil.toString( i + 4 ) );
        doDuoTableCellsLinkFight( component, out, rb.getString( "fightTable.3-5" ), fightListMap.get( 8 ), context,
                                  editAccess,
                                  linkToFight );
        out.endElement( JSF_TR );
        ...
        out.writeAttribute( ATTR_CLASS, i % 2 == 0 ? "odd" : "even", null );
        doTableCell( component, out, "18", VAL_CENTER, true, TypeUtil.toString( i - 1 ) );
        doDuoTableCellsLinkFight( component, out, rb.getString( "fightTable.2-3" ), fightListMap.get( 4 ), context,
                                  editAccess,
                                  linkToFight );
        ...
        doTableCell( component, out, "18", VAL_CENTER, true, TypeUtil.toString( i + 4 ) );
        doDuoTableCellsLinkFight( component, out, rb.getString( "fightTable.1-4" ), fightListMap.get( 9 ), context,
                                  editAccess,
                                  linkToFight );
        out.endElement( JSF_TR );
        ...
        out.writeAttribute( ATTR_CLASS, i % 2 == 0 ? "odd" : "even", null );
        doTableCell( component, out, "18", VAL_CENTER, true, TypeUtil.toString( i - 1 ) );
        doDuoTableCellsLinkFight( component, out, rb.getString( "fightTable.4-5" ), fightListMap.get( 5 ), context,
                                  editAccess,
                                  linkToFight );
        ...
        doTableCell( component, out, "18", VAL_CENTER, true, TypeUtil.toString( i + 4 ) );
        doDuoTableCellsLinkFight( component, out, rb.getString( "fightTable.2-5" ), fightListMap.get( 10 ), context,
                                  editAccess,
                                  linkToFight );
        out.endElement( JSF_TR );
    ...
    public static void doDuoPooltable( UIComponent component, FacesContext context, ResponseWriter out,
                                       String tableWidht, String tableBorder, ResourceBundle rb,
                                       List<DuoDoublePoolItem> duoTeamList )
        throws IOException
    {
        out.startElement( JSF_TABLE, component );
        out.writeAttribute( ATTR_CLASS, FANCY_TABLE, null );
        ...
        doPooltableHeadRow( component, context, out, rb );
        doDuoPooltableRow( component, context, out, duoTeamList );
        out.endElement( JSF_TABLE );
    }

    public static void doDuoPooltableRow( UIComponent component, FacesContext context, ResponseWriter out,
                                          List<DuoDoublePoolItem> duoTeamList )
        throws IOException
    {
        DuoDoublePoolItem item;

        for ( int i = 1; i < 6; i++ )
        {
            if ( duoTeamList.size() >= i )
            {
                item = duoTeamList.get( i - 1 );
                out.startElement( JSF_TR, component );
                out.writeAttribute( ATTR_CLASS, i % 2 == 0 ? "odd" : "even", null );
                doTableCell( component, out, "15%", VAL_CENTER, false, item.getDuoTeam().getName() + " / "
                    + item.getDuoTeam().getName2() );
                doTableCell( component, out, "15%", VAL_CENTER, false, item.getDuoTeam().getFirstname() + " / "
                    + item.getDuoTeam().getFirstname2() );
                doTableCell( component, out, "15%", VAL_CENTER, false, item.getDuoTeam().getTeam().getTeamName() );
                doTableCell( component, out, "3%", VAL_CENTER, false, String.valueOf( i ) );
                if ( i == 1 )
                {
                    doTableCell( component, out, "6%", VAL_CENTER, false, 2, null, "invalid" );
    ...
    public static void doDuoTableCellsLinkFight( UIComponent component, ResponseWriter out, String text,
                                                 DuoFight fight, FacesContext context, boolean editAccess,
                                                 String linkToFight )
        throws IOException
    {
        if ( editAccess && fight != null )
        ...
        else
        {
            ...
            // fighter points red and blue
            doTableCell( component, out, TypeUtil.toString( 24 ), VAL_CENTER, false,
                         TypeUtil.toString( fight.getPointsRedMax() ) );
            doTableCell( component, out, TypeUtil.toString( 24 ), VAL_CENTER, false,
                         TypeUtil.toString( fight.getPointsBlueMax() ) );
        }
    }
