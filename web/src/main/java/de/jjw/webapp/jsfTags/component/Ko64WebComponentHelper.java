 ...
 *
 * File    : Ko64WebComponentHelper.java
 * Created : 17 Jun 2012
...
public class Ko64WebComponentHelper
    extends AbstractWebComponentHelper
{

    public static void doMainround( UIComponent component, FacesContext context, ResponseWriter out, String style,
                                    ResourceBundle rb, Map<Integer, Fight> fightListA, Map<Integer, Fight> fightListB,
                                    Fight finalFight, boolean editAccess, String linkToFight )
        throws IOException
    {
        ...
        doTableCellWithRowSpanAndLink( component, out, _15, "29", fightListA.get( IValueConstants._29 ), editAccess,
                                       linkToFight, 3, BORDER_TOP | BORDER_BOTTOM, context );
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        doTableCell( component, out, _15, VAL_CENTER, PLAIN, null );
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        ...
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        doTableCellWithRowSpanAndLink( component, out, _15, "47", fightListA.get( IValueConstants._14 ), editAccess,
                                       linkToFight, 3, PLAIN, context );
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        doTableCell( component, out, _15, VAL_CENTER, PLAIN, null );
        ...
        doTableCellWithRowSpanAndLink( component, out, _15, "2", fightListB.get( IValueConstants._15 ), editAccess,
                                       linkToFight, 3, BORDER_TOP | BORDER_BOTTOM, context );
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        doTableCell( component, out, _15, VAL_CENTER, PLAIN, null );
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
    ...
    public static void doLooserRound( UIComponent component, FacesContext context, ResponseWriter out, String style,
                                      ResourceBundle rb, Map<Integer, Fight> fightListA,
                                      Map<Integer, Fight> fightListB, boolean editAccess, String linkToFight )
        throws IOException
    {
        out.startElement( JSF_TABLE, component );
        out.writeAttribute( ATTR_CLASS, style, null );
