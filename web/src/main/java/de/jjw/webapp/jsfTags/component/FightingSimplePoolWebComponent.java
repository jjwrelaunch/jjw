 ...
 *
 * File    : FightingSimplePoolWebComponent.java
 * Created : 09 Jun 2010
...
public class FightingSimplePoolWebComponent
    extends UIOutput
    implements HtmlConstants, IGlobalWebConstants
{

    FightingSimplePoolClass fightingclass;
    ...
    public FightingSimplePoolWebComponent()
    {
        // setRendererType(RENDERER_TYPE);
    }

    public FightingSimplePoolClass getFightingclass()
    {
        return fightingclass;
    }

    public void setFightingclass( FightingSimplePoolClass fightingclass )
    {
        ...
        throws IOException
    {
        ...
        fightingclass = (FightingSimplePoolClass) attrs.get( FIGHTINGCLASS );
        boolean readOnly =
        ...
        throws IOException
    {
        ...
        doTableCellsLinkFight( out, rb.getString( "fightTable.1-2" ), fightingclass.getFightListMap().get( 1 ), context );

        doTableCell( out, "48", null, false, "SPACER" );

        doTableCell( out, "18", VAL_CENTER, true, TypeUtil.toString( i + 4 ) );
        doTableCellsLinkFight( out, rb.getString( "fightTable.1-3" ), fightingclass.getFightListMap().get( 6 ), context );
        out.endElement( JSF_TR );
        ...
        out.writeAttribute( ATTR_CLASS, i % 2 == 0 ? "odd" : "even", null );
        doTableCell( out, "18", VAL_CENTER, true, TypeUtil.toString( i - 1 ) );
        doTableCellsLinkFight( out, rb.getString( "fightTable.3-4" ), fightingclass.getFightListMap().get( 2 ), context );

        doTableCell( out, "48", null, false, "SPACER" );

        doTableCell( out, "18", VAL_CENTER, true, TypeUtil.toString( i + 4 ) );
        doTableCellsLinkFight( out, rb.getString( "fightTable.2-4" ), fightingclass.getFightListMap().get( 7 ), context );
        out.endElement( JSF_TR );
        ...
        out.writeAttribute( ATTR_CLASS, i % 2 == 0 ? "odd" : "even", null );
        doTableCell( out, "18", VAL_CENTER, true, TypeUtil.toString( i - 1 ) );
        doTableCellsLinkFight( out, rb.getString( "fightTable.1-5" ), fightingclass.getFightListMap().get( 3 ), context );

        doTableCell( out, "48", null, false, "SPACER" );

        doTableCell( out, "18", VAL_CENTER, true, TypeUtil.toString( i + 4 ) );
        doTableCellsLinkFight( out, rb.getString( "fightTable.3-5" ), fightingclass.getFightListMap().get( 8 ), context );
        out.endElement( JSF_TR );
        ...
        out.writeAttribute( ATTR_CLASS, i % 2 == 0 ? "odd" : "even", null );
        doTableCell( out, "18", VAL_CENTER, true, TypeUtil.toString( i - 1 ) );
        doTableCellsLinkFight( out, rb.getString( "fightTable.2-3" ), fightingclass.getFightListMap().get( 4 ), context );

        doTableCell( out, "48", null, false, "SPACER" );

        doTableCell( out, "18", VAL_CENTER, true, TypeUtil.toString( i + 4 ) );
        doTableCellsLinkFight( out, rb.getString( "fightTable.1-4" ), fightingclass.getFightListMap().get( 9 ), context );
        out.endElement( JSF_TR );
        ...
        out.writeAttribute( ATTR_CLASS, i % 2 == 0 ? "odd" : "even", null );
        doTableCell( out, "18", VAL_CENTER, true, TypeUtil.toString( i - 1 ) );
        doTableCellsLinkFight( out, rb.getString( "fightTable.4-5" ), fightingclass.getFightListMap().get( 5 ), context );

        doTableCell( out, "48", null, false, "SPACER" );

        doTableCell( out, "18", VAL_CENTER, true, TypeUtil.toString( i + 4 ) );
        doTableCellsLinkFight( out, rb.getString( "fightTable.2-5" ), fightingclass.getFightListMap().get( 10 ),
                               context );
        out.endElement( JSF_TR );
    ...
    private void doTableCellsLinkFight( ResponseWriter out, String text, Fight fight, FacesContext context )
        throws IOException
    {
    ...
    private void doPooltableRow( FacesContext context, ResponseWriter out )
        throws IOException
    {
        FightingSimplePoolItem item;
        for ( int i = 1; i < 6; i++ )
        {
            if ( fightingclass.getFighterList().size() >= i )
            {
                item = fightingclass.getFighterList().get( i - 1 );
                out.startElement( JSF_TR, this );
                out.writeAttribute( ATTR_CLASS, i % 2 == 0 ? "odd" : "even", null );
