 ...
 *
 * File    : AbstractNewaWebComponentHelper.java
 * Created : 05 Jun 2010
...
public abstract class AbstractNewaWebComponentHelper
    implements HtmlConstants, IGlobalWebConstants
{
    ...
    protected static void doTableCell( UIComponent component, ResponseWriter out, String width, String valign,
                                       boolean firstname, NewaFight fight, int redOrBlue, int style )
        throws IOException
    {
    ...
    protected static void doTableCell( UIComponent component, ResponseWriter out, String width, String valign,
                                       boolean firstname, NewaFight fight, int redOrBlue, int colspan, int style )
        throws IOException
    {
        NewaFighter fighter;
    ...
    protected static void doTableCellWithRowSpanAndLinkFor3rdPlace( UIComponent component, ResponseWriter out, String width,
                                                         String text, NewaFight fight, boolean editAccess,
                                                         String linkToFight, int rowspan, int style,
                                                         FacesContext context, Map<Integer, NewaFight> fightListA , Map<Integer, NewaFight> fightListB  )
        throws IOException
    {
