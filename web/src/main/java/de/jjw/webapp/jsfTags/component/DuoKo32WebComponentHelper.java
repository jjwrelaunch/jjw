 ...
 *
 * File    : DuoKo32WebComponentHelper.java
 * Created : 05 Jun 2010
...
public class DuoKo32WebComponentHelper
    extends DuoKo16WebComponentHelper
{
        ...
        throws IOException
    {
        ...
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        doTableCellWithRowSpanAndLink( component, out, _15, "29", fightListA.get( 0 ), editAccess, linkToFight, 16,
                                       PLAIN, context );
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        doTableCell( component, out, _15, VAL_CENTER, PLAIN, null );
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        ...
        if ( TypeUtil.LONG_EMPTY != finalFight.getWinnerId() )
        {
            if ( finalFight.getTeamIdRed() == finalFight.getWinnerId() )
            {
                doTableCell( component, out, _100, VAL_CENTER, BORDER_BOTTOM | HIGHLIGHT_WINNER,
                             finalFight.getDuoTeamRed().getName() );
            }
            else
            {
                ...
                {
                    doTableCell( component, out, _100, VAL_CENTER, BORDER_BOTTOM | HIGHLIGHT_WINNER,
                                 finalFight.getDuoTeamBlue().getName() );
                }
                else
                {
                    doTableCell( component, out, _100, VAL_CENTER, BORDER_BOTTOM | HIGHLIGHT_WINNER,
        ...
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        doTableCellWithRowSpanAndLink( component, out, _15, "30", fightListB.get( 0 ), editAccess, linkToFight, 16,
                                       PLAIN, context );
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        doTableCell( component, out, _100, VAL_CENTER, PLAIN, null );
        out.endElement( JSF_TR );
