 ...
 *
 * File    : DuoKo16ComplexListPDF.java
 * Created : 05 Jun 2010
...
public class DuoKo16ComplexListPDF
    implements IValueConstants
{
    ...
    public DuoKo16ComplexListPDF( String ressourceBundle, DuoKoClass duoclass, HttpServletResponse response,
                                  String headLine, Locale local )
        throws Exception
    {
        ...
        createTables( duoclass );
    }

    public DuoKo16ComplexListPDF( String ressourceBundle, HttpServletResponse response, String headLine, Locale local )
    {
        this.response = response;
        this.rb = ResourceBundle.getBundle( ressourceBundle, local );
        this.headLine = headLine;
    ...
    public void createTables( DuoKoClass duoclass )
        throws Exception
    {
        try
        {
            ...
            if ( duoclass != null )
            {
                ...
                writeText( 600, 510, duoclass.getDuoclassName(), true, 14 );

                fillMainRoundTable( duoclass );

                fillLoserRoundTable( duoclass );
                manageFightListForKo16( duoclass );
            }
            doc.close();
        ...
        {
            log.error( "DuoKo16ComplexListPDF.createTables: Exception: \ncan not create pdf document \n", e );
            throw e;
        }
    }
    ...
    private void fillMainRoundTable( DuoKoClass fc )
        throws Exception
    {
        int height = _12;
        int textsize = _8;
        ...
        throws Exception
    {
            ...
            && fc.getFightListLooserMapPoolA().get( _0 ).getWinnerId().longValue() != TypeUtil.LONG_EMPTY )
        {
            writeText( _738, konst - height + _2, fc.getFightListLooserMapPoolA().get( _0 ).getDuoTeamRed().getName()
                           + "/" + fc.getFightListLooserMapPoolA().get( _0 ).getDuoTeamRed().getName2(), BOOLEAN_TRUE,
                       textSize,
                       _0 );
        }
        if ( fc.getFightListLooserMapPoolA().get( _0 ).getWinnerId().longValue() == fc.getFightListLooserMapPoolA().get(
            ...
            && fc.getFightListLooserMapPoolA().get( _0 ).getWinnerId().longValue() != TypeUtil.LONG_EMPTY )
        {
            writeText( _738, konst - height + _2, fc.getFightListLooserMapPoolA().get( _0 ).getDuoTeamBlue().getName()
                           + "/" + fc.getFightListLooserMapPoolA().get( _0 ).getDuoTeamBlue().getName2(), BOOLEAN_TRUE,
                       textSize,
                       _0 );
        }
            ...
            && fc.getFightListLooserMapPoolB().get( _0 ).getWinnerId().longValue() != TypeUtil.LONG_EMPTY )
        {
            writeText( _738, konst - _9 * height + _2,
                       fc.getFightListLooserMapPoolB().get( _0 ).getDuoTeamRed().getName() + "/"
                           + fc.getFightListLooserMapPoolB().get( _0 ).getDuoTeamRed().getName2(), BOOLEAN_TRUE,
                       textSize, _0 );
        }
        if ( fc.getFightListLooserMapPoolB().get( _0 ).getWinnerId().longValue() == fc.getFightListLooserMapPoolB().get(
                                                                                                                         _0 ).getTeamIdBlue()
        ...
        {
            writeText( _738, konst - _9 * height + _2,
                       fc.getFightListLooserMapPoolB().get( _0 ).getDuoTeamBlue().getName() + "/"
                           + fc.getFightListLooserMapPoolB().get( _0 ).getDuoTeamBlue().getName2(), BOOLEAN_TRUE,
                       textSize, _0 );
        }
        ...
        throws Exception
    {
        ...
        {
            log.error( "DuoKo16ComplexListPDF.writeText: Exception: \n can not create pdf document \n", e );
        }
        return;
    }
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            if ( redOrBlue == FIGHTER_RED && fight.getDuoTeamRed() != null )
            {
                ...
                if ( fight.getDuoTeamRed().getName2() != null )
                {
                    sb.append( "/" );
                    sb.append( fight.getDuoTeamRed().getName2() );
                    sb.append( SPACE );
                }
            ...
            if ( redOrBlue == FIGHTER_BLUE && fight.getDuoTeamBlue() != null )
            {
                ...
                if ( fight.getDuoTeamBlue().getName2() != null )
                {
                    sb.append( "/" );
                    sb.append( fight.getDuoTeamBlue().getName2() );
                    sb.append( SPACE );
                }
     ...
     * @param fc
     */
    private void manageFightListForKo16( DuoKoClass fc )
    {
        try
        {
            int count = _1;

            count = manageFightList( fc.getFightListMapPoolA(), _3, _6, count, BOOLEAN_TRUE );
            count = manageFightList( fc.getFightListMapPoolB(), _3, _6, count, BOOLEAN_TRUE );
            count = manageFightList( fc.getFightListMapPoolA(), _1, _2, count, BOOLEAN_FALSE );
            count = manageFightList( fc.getFightListMapPoolB(), _1, _2, count, BOOLEAN_FALSE );

            count = manageFightList( fc.getFightListLooserMapPoolA(), _4, _5, count, BOOLEAN_TRUE );
            count = manageFightList( fc.getFightListLooserMapPoolB(), _4, _5, count, BOOLEAN_TRUE );
            count = manageFightList( fc.getFightListLooserMapPoolA(), _2, _3, count, BOOLEAN_FALSE );
            count = manageFightList( fc.getFightListLooserMapPoolB(), _2, _3, count, BOOLEAN_FALSE );
            ...
            count = manageFightList( fc.getFightListLooserMapPoolA(), _1, _1, count, BOOLEAN_FALSE );
            count = manageFightList( fc.getFightListLooserMapPoolB(), _1, _1, count, BOOLEAN_FALSE );
            count = manageFightList( fc.getFightListLooserMapPoolA(), _0, _0, count, BOOLEAN_FALSE );
            count = manageFightList( fc.getFightListLooserMapPoolB(), _0, _0, count, BOOLEAN_FALSE );

            createFightList( fc.getFinalFight(), count );
        }
        catch ( Exception e )
        {
            log.error( "DuoKo16ComplexListPDF.manageFightListForKo16: Exception: \ncan not create pdf document \n", e );
        }
    }

    protected int manageFightList( Map<Integer, DuoFight> fightMap, int start, int end, int count, boolean firstRound )
        throws Exception
    {
        for ( int i = start; i <= end; i++ )
        {
            ...
            createFightList( fightMap.get( i ), count );
            count++;
        }
        return count;
    }

    protected void createFightList( DuoFight fight, int nr )
        throws Exception
    {
        ...
        LogListPDF FL = new LogListPDF( rb, cb, fight, headLine );
        FL.createFightList( duoclass.getAge().getDescription(), duoclass.getDuoclassName(), String.valueOf( nr ) );
        cb.stroke();
    }
