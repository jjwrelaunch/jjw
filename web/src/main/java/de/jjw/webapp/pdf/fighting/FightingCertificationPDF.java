 ...
 *
 * File    : FightingCertificationPDF.java
 * Created : 05 Jun 2010
...
public class FightingCertificationPDF
{
    ...
    public FightingCertificationPDF( String resourceBundle, HttpServletResponse response, FightingCertification dto,
                                     Locale locale )
    {
    ...
    public void show( FightingCertification dto, Locale locale )
    {
        try
        {
            ...
            if ( dto.getFighterList() != null && dto.getFighterList().size() > TypeUtil.INT_DEFAULT )
            {
                ...
                for ( Fighter fighter : dto.getFighterList() )
                {
     ...
     * @return
     */
    private String buildAgeClassCaption( FightingCertification dto, Locale locale )
    {
        ...
        ageClassCaption.append( dto.getFightingclassCaption() ).append( KG );
