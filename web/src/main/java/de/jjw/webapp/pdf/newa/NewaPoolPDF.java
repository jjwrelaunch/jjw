    ...
    implements IValueConstants
{
    ...
    private NewaSimplePoolClass newaclass;
    ...
    public NewaPoolPDF( String ressourceBundle, NewaSimplePoolClass newaclass,
    ...
    public NewaPoolPDF( String ressourceBundle, HttpServletResponse response, String headLine, Locale local )
    {
        this.response = response;
        this.rb = ResourceBundle.getBundle( ressourceBundle, local );
        this.headLine = headLine;
        ...
        throws Exception
    {
        try
        {
            ...
            writeText( 600,
                ...
                + CodestableMain.getInstance().getCodestableCodeValueByType( ICodestableTypeConstants.TYPE_SEX,
                           ...
                           + newaclass.getWeightclass() + KG, BOOLEAN_TRUE, 14 );
            writeText( _24, _24, rb.getString( "pdf.copyright" ) + "", BOOLEAN_FALSE, 8 );
            createResultTable( 150 );
            fillResultTable( 150 );
            createFightTable( 280, _0 );
            ...
            {
                fight = newaclass.getFightListMap().get( Integer.valueOf( i + _1 ) );
                if ( fight == null )
                {
                    continue;
                }
                ...
                doc.newPage();
                doc.add( new Paragraph( SPACE ) );
                FL = new NewaLogListPDF( rb, cb, fight, headLine );
        ...
        {
            log.error( "NewaPoolPDF.createPool: Exception: \ncan not create pdf document \n", e );
            throw e;
        }
    }
        ...
        throws Exception
    {
        ...
        for ( int m = _0; m < 2; m++ )
        {
            for ( int i = _0; i < _5; i++ )
            {
                int j = _24 + m * 290;
                j += _40;
                fight = ( newaclass.getFightListMap().get( Integer.valueOf( _5 * m + i + _1 ) ) );
                if ( fight != null )
                {
 ...
 newaclass.getFighterList().get( i ).getFighter().getName(),
            ...
            j += _80;
            writeText( j + _40, _545 - konst - i * height,
                       newaclass.getFighterList().get( i ).getFighter().getFirstname(), BOOLEAN_FALSE );
            j += _80;
            writeText( j + _40, _545 - konst - i * height,
                       newaclass.getFighterList().get( i ).getFighter().getTeam().getTeamName(), BOOLEAN_FALSE, 7,
                       1 );
            j += _80;
            ...
            j += _30;
            writeText( j + _15, _545 - konst - i * height,
                       String.valueOf( newaclass.getFighterList().get( i ).getResult().getUBCount() ),
                       BOOLEAN_FALSE );
            j += _30;
            writeText( j + _15, _545 - konst - i * height,
                       String.valueOf( newaclass.getFighterList().get( i ).getPlace() ), BOOLEAN_FALSE );
            cb.stroke();
        }
    }
