 ...
 *
 * File    : FightingKo16ComplexListPDF.java
 * Created : 05 Jun 2010
...
public class FightingKo16ComplexListPDF
    implements IValueConstants
{
    ...
    protected FightingKoClass fightingclass;
    ...
    public FightingKo16ComplexListPDF( String ressourceBundle, FightingKoClass fightingclass,
        ...
        throws Exception
    {
        ...
        createTables( fightingclass );
    }

    public FightingKo16ComplexListPDF( String ressourceBundle, HttpServletResponse response, String headLine,
                                       Locale local )
    {
        this.response = response;
        this.rb = ResourceBundle.getBundle( ressourceBundle, local );
        ...
        throws Exception
    {
        try
        {
            ...
            if ( fightingclass != null )
            {
                ...
                writeText( 600, 510, fightingclass.getAge().getDescription()
                    ...
                    + fightingclass.getWeightclass() + KG, true, 14 );
                ...
                fillMainRoundTable( fightingclass );

                fillLoserRoundTable( fightingclass );
                manageFightListForKo16( fightingclass );
            }
            doc.close();
        ...
        {
            log.error( "FightingKo16ComplexListPDF.createTables: Exception: \ncan not create pdf document \n", e );
            throw e;
        }
    }
    ...
    private void fillMainRoundTable( FightingKoClass fc )
        throws Exception
    {
        int height = _12;
    ...
    private void fillLoserRoundTable( FightingKoClass fc )
        throws Exception
    {
        int height = _12;
        ...
        throws Exception
    {
        ...
        {
            log.error( "FightingFightList.writeText: Exception: \n can not create pdf document \n", e );
        }
        return;
    }
     ...
     * @param fc
     */
    private void manageFightListForKo16( FightingKoClass fc )
    {
        try
        {
            int count = _1;
    ...
    protected int manageFightList( Map<Integer, Fight> fightMap, int start, int end, int count, boolean firstRound )
        throws Exception
    {
    ...
    protected void createFightList( Fight fight, int nr )
        throws Exception
    {
