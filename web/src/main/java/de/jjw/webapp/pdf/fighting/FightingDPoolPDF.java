    ...
    implements IValueConstants
{
    ...
    private FightingDoublePoolClass fightingclass;
    ...
    public FightingDPoolPDF( String ressourceBundle, FightingDoublePoolClass fightingclass,
    ...
    public FightingDPoolPDF( String ressourceBundle, HttpServletResponse response, String headLine, Locale local )
    {
        this.response = response;
        this.rb = ResourceBundle.getBundle( ressourceBundle, local );
        this.headLine = headLine;
        ...
        throws Exception
    {
        try
        {
            ...
            writeText( 600, 510, fightingclass.getAge().getDescription()
                ...
                + fightingclass.getWeightclass() + " Kg", BOOLEAN_TRUE, _14 );
            writeText( _24, _24, rb.getString( "pdf.copyright" ) + "", BOOLEAN_FALSE, 8 );

            writeText( 600, _540, headLine, BOOLEAN_TRUE, 16 );

            createResultTable( _0 );
            fillResultTable( _0, fightingclass.getFighterListPoolA() );
            createFightTable( 130, _0 );
            fillFightTable( 130, fightingclass.getFightListMapPoolA() );

            createResultTable( 264 );
            fillResultTable( 264, fightingclass.getFighterListPoolB() );
            createFightTable( 394, _1 );
            fillFightTable( 394, fightingclass.getFightListMapPoolB() );
            ...
            {
                if ( fightingclass.getFightListMapPoolA().get( Integer.valueOf( i ) ) != null )
                {
                    createFightList( fightingclass.getFightListMapPoolA().get( Integer.valueOf( i ) ), FightNr[i] );
                }

                if ( fightingclass.getFightListMapPoolA().get( Integer.valueOf( i + _1 ) ) != null )
                {
                    createFightList( fightingclass.getFightListMapPoolA().get( Integer.valueOf( i + _1 ) ), FightNr[i
                        + _1] );
                }

                if ( fightingclass.getFightListMapPoolB().get( Integer.valueOf( i ) ) != null )
                {
                    createFightList( fightingclass.getFightListMapPoolB().get( Integer.valueOf( i ) ), FightNr[i + 10] );
                }

                if ( fightingclass.getFightListMapPoolB().get( Integer.valueOf( i + _1 ) ) != null )
                {
                    createFightList( fightingclass.getFightListMapPoolB().get( Integer.valueOf( i + _1 ) ), FightNr[i
                        + 10 + _1] );
                }
        ...
        {
            log.error( "FightingDPoolPDF.createPool: Exception: \ncan not create pdf document \n", e );
            throw e;
        }
    }
    ...
    private void fillFightTable( int konst, Map<Integer, Fight> fightMap )
        throws Exception
    {
        int height = _18;
        konst += height;
    ...
    private void fillResultTable( int konst, List<FightingDoublePoolItem> fighterList )
        throws Exception
    {
        int height = _18, j = _0;
        konst += height;
