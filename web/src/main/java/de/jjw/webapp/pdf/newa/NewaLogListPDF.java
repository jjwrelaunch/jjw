    ...
    implements IValueConstants
{
    ...
    public NewaLogListPDF( ResourceBundle rb, PdfContentByte cb, NewaFight fight, String headLine )
    {
        this.rb = rb;
        this.cb = cb;
        this.fight = fight;
    ...
    public NewaLogListPDF( String rb, String headLine, HttpServletResponse response, FriendlyNewaFight friendlyFight )
        throws Exception
    {
    ...
    public NewaLogListPDF( String rb, String headLine, HttpServletResponse response )
    {
        this.rb = ResourceBundle.getBundle( rb, response.getLocale() );
        this.response = response;
        this.headLine = headLine;
    ...
    public void createFightList( String age, String weightClass, String fightNumber )
    {
        try
        {
            ...
            writeText( _56, 645, rb.getString( "pdf.logList.fightNumber" ) + " " + fightNumber, cb, BOOLEAN_TRUE, _12,
                       _1 );
            writeText( _56, 625, "Newaza", cb, BOOLEAN_TRUE, _12, _1 );
        ...
        throws Exception
    {
        ...
        writeText( _60, 325, rb.getString( "pdf.logList.part4" ), cb, BOOLEAN_TRUE, _14, _1 );
        writeText( _60, _190, rb.getString( "pdf.logList.result" ), cb, BOOLEAN_TRUE, _14, _1 );


        writeText( _60, 280, rb.getString( "pdf.logList.shido" ), cb, BOOLEAN_TRUE, _12, _1 );
    ...
    private void createFrames( PdfContentByte cb )
    {
        try
        {
            ...
            cb.rectangle( _56, _300, _140, _60 ); // leer
            ...
            for ( int i = _0; i < _2; i++ )
            {
                ...
                cb.rectangle( i * _180 + _196, _300, _90, _60 );
