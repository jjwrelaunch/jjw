...
public class FightingKo32ComplexListPDF
    extends FightingKo16ComplexListPDF
{

    public FightingKo32ComplexListPDF( String ressourceBundle, FightingKoClass fightingclass,
    ...
    public FightingKo32ComplexListPDF( String ressourceBundle, HttpServletResponse response, String headLine,
                                       Locale local )
    {
        ...
        throws Exception
    {
        try
        {
            ...
            {
                writeTextCentral( 420, 540, headLine, true, _16 );
                writeTextCentral( 420, 510, fightingclass.getAge().getDescription()
                    + SPACE
                ...
                BasePDF.addWatermark( writer.getDirectContentUnder(), "Fighting", 140, true );
                manageFightListForKo32( fightingclass );
            }
            doc.close();
        ...
        {
            log.error( "FightingKo32ComplexListPDF.createMainRoundTable: Exception: \ncan not create pdf document \n",
                       e );
            throw e;
        }
    }
     ...
     * @param Ko
     */
    private void manageFightListForKo32( FightingKoClass fc )
    {
        try
        {
        ...
        {
            log.error( "FightingKo32ComplexListPDF.manageFightListForKo32: Exception: \ncan not create pdf document \n",
                       e );
        }
    }
