...
public class FightingKo64ComplexListPDF
    extends FightingKo16ComplexListPDF
{
    ...
    public FightingKo64ComplexListPDF( String ressourceBundle, FightingKoClass fightingclass,
                                       HttpServletResponse response, String headLine, Locale local )
        throws Exception
    {
        super( ressourceBundle, fightingclass, response, headLine, local );
    }

    public FightingKo64ComplexListPDF( String ressourceBundle, HttpServletResponse response, String headLine,
                                       Locale local )
    {
    ...
    @Override
    public void createTables( FightingKoClass fightingclass )
        throws Exception
    {
        try
        {
            ...
            if ( fightingclass != null )
            {
                ...
                headline2 =
                    fightingclass.getAge().getDescription()
                        + SPACE
                        ...
                        + fightingclass.getWeightclass() + KG;
                writeText( 340, 760, headline2, true, 14 );
                fillMainRoundTable( fightingclass.getFightListMapPoolA() );
                fillFinal( fightingclass );
            }
            cb.stroke();
            // Pool B
            doc.setPageSize( PageSize.A4 );
            ...
            if ( fightingclass != null )
            {
                writeText( 340, 790, headLine, true, _16 );
                writeText( 340, 760, headline2, true, 14 );
                fillMainRoundTable( fightingclass.getFightListMapPoolB() );
                fillFinal( fightingclass );
            }
            cb.stroke();
            ...
            if ( fightingclass != null )
            {
                ...
                fillLoserRoundTable( fightingclass.getFightListLooserMapPoolA() );
            }
            cb.stroke();
            ...
            if ( fightingclass != null )
            {
                writeText( 600, 540, headLine, true, _16 );
                writeText( 600, 510, headline2, true, 14 );
                fillLoserRoundTable( fightingclass.getFightListLooserMapPoolB() );
            }
            cb.stroke();

            if ( fightingclass != null )
            {
                manageFightListForKo64( fightingclass );
            }
            doc.close();
        ...
        {
            log.error("FightingKo64ComplexListPDF.createMainRoundTable: Exception: \ncan not create pdf document \n", e);
            throw e;
        }
    }
    ...
    private void fillMainRoundTable( Map<Integer, Fight> fightListMapPool )
        throws Exception
    {
        int height = 12;
    ...
    private void fillFinal( FightingKoClass fc )
        throws Exception
    {
        int height = 12;
        int konstFinal = 4;
    ...
    private void fillLoserRoundTable( Map<Integer, Fight> fightListMapPool )
        throws Exception
    {
        int height = 12;
    ...
    private void manageFightListForKo64( FightingKoClass fc )
    {
        try
        {
            int count = _1;
            ...
            count = manageFightList( fc.getFightListLooserMapPoolA(), _22, _29, count, BOOLEAN_TRUE );
            count = manageFightList( fc.getFightListLooserMapPoolB(), _22, _29, count, BOOLEAN_TRUE );
            count = manageFightList( fc.getFightListLooserMapPoolA(), _14, _21, count, BOOLEAN_FALSE );
            count = manageFightList( fc.getFightListLooserMapPoolB(), _14, _21, count, BOOLEAN_FALSE );

            count = manageFightList( fc.getFightListLooserMapPoolA(), _10, _13, count, BOOLEAN_FALSE );
            count = manageFightList( fc.getFightListLooserMapPoolB(), _10, _13, count, BOOLEAN_FALSE );
            count = manageFightList( fc.getFightListLooserMapPoolA(), _6, _9, count, BOOLEAN_FALSE );
            count = manageFightList( fc.getFightListLooserMapPoolB(), _6, _9, count, BOOLEAN_FALSE );

            count = manageFightList( fc.getFightListLooserMapPoolA(), _4, _5, count, BOOLEAN_FALSE );
            count = manageFightList( fc.getFightListLooserMapPoolB(), _4, _5, count, BOOLEAN_FALSE );
        ...
        {
            log.error( "FightingKo64ComplexListPDF.manageFightListForKo64: Exception: \ncan not create pdf document \n",
                       e );
        }
    }
}