...
<f:verbatim>
  ...
  <script type="text/javascript">
    $( document ).ready( function()
    {
      ...
      highlight( "<h:outputText value="#{tatamiNewaclassOverview.sortColumn}"/>" );
...
<h:form id="tatamiNewaclassOverview">

  <h:outputText value="#{tatamiNewaclassOverview.text}"/>
  <c:if test="${tatamiNewaclassOverview.fighters != null}">

    <c:if test="${fn:length(tatamiNewaclassOverview.fighters) > 0}">
      ...
      <t:dataTable sortColumn="#{tatamiNewaclassOverview.sortColumn}"
                   value="#{tatamiNewaclassOverview.fighters}" var="cty" border="0" cellspacing="0"
                   cellpadding="0" styleClass="fancyTable" rowClasses="odd,even" width="800px" id="fightingClassTable"
                   forceId="true" binding="#{tatamiNewaclassOverview.dataTable}">
        ...
        <t:column styleClass="center">
          ...
          <h:commandLink action="#{tatamiNewaclassOverview.showNewaclassAsWeb}" rendered="#{cty.classStartet}">
          ...
          <h:commandLink action="#{tatamiNewaclassOverview.showNewaclassAsPdf}">
        ...
        <t:column sortable="true">
          ...
          <h:selectBooleanCheckbox onchange="submit()" value="#{cty.classStartet}"
                                   valueChangeListener="#{tatamiNewaclassOverview.startClassListener}"/>
          <h:outputText value="&nbsp;" escape="false"/>
