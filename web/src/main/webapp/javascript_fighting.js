...
//	UPDATES
//
//	15.12.2008: var user_input; function user_input_log; function alarmUserLog;
...
function gleichstand()
{
            ...
            _red == _blue )
    {
        ...
        if ( tmp_leftIppons == tmp_rightIppons )
        {
            ...
            //Anzeige TIE
            alert( "TIE - set time to ZERO using the arrows on the display\n\nlet all other counts untouched\n\n\nGLEICHSTAND - Zeit mit Hilfe der Pfeile auf NULL stellen\n\nLassen Sie alle anderen Werte stehen\n" );
...
// clock controls
//========================================================================================
function switchClock( clockTypeOut, clockTypeIn )
{
    document.getElementById( clockTypeOut ).style.display = "none";
    document.getElementById( clockTypeOut + "Caption" ).style.display = "none";
    document.getElementById( clockTypeIn ).style.display = "block";
    document.getElementById( clockTypeIn + "Caption" ).style.display = "block";
}

function toggleClock( side )
{
    if ( clockDisplayed[side] == side + "HoldingClock" )
    {
        clockDisplayed [side] = side + "InjuryClock";
        switchClock( side + "HoldingClock", side + "InjuryClock" );
    }
    else
    {
        clockDisplayed [side] = side + "HoldingClock";
        switchClock( side + "InjuryClock", side + "HoldingClock" );
    }
}
...
function updatePoints( side )
{
    ...
    if ( proofHansokumake() )
    {
        if ( checkHansokumake( "left" ) )
        {
            ...
            {
                document.getElementById( "rightPoints.2" ).src = "../images/clock/0_x_large.png";
        ...
        if ( checkHansokumake( "right" ) )
        {
            ...
            if ( !checkHansokumake( "left" ) )
            {
                document.getElementById( "leftPoints.2" ).src = "../images/clock/0_x_large.png";
    ...
    // benoetigt function checkFullIppon(side)
{
    ...
    if ( checkFullIppon( "left" ) )
    {
        changeImage( "leftIppon1ImageFlag", "blinker.gif" );
        changeImage( "leftIppon2ImageFlag", "blinker.gif" );
        changeImage( "leftIppon3ImageFlag", "blinker.gif" );
        proof = true;
    }
    if ( checkFullIppon( "right" ) )
    {
        changeImage( "rightIppon1ImageFlag", "blinker.gif" );
        changeImage( "rightIppon2ImageFlag", "blinker.gif" );
        changeImage( "rightIppon3ImageFlag", "blinker.gif" );
        proof = true;
    }
    if ( proof )
    {
...
function increaseIppon( side, ippon )
{
    ...
    document.getElementById( side + "Ippon" + ippon + "TDFlag" ).style.backgroundColor = hiLightColor;

    if ( ipponList[side][ippon] < 21 )
    {
        changeImage( side + "Ippon" + ippon + "ImageFlag", "ippon_active" + ipponList[side][ippon] + ".png" );
    }
    else
    {
        changeImage( side + "Ippon" + ippon + "ImageFlag", "ippon_activexx.png" );
    }
...
function decreaseIppon( side, ippon )
{
    ...
    else
    {
        ...
        if ( ipponList[side]["1"] < 21 )
        {
            changeImage( side + "Ippon1ImageFlag", "ippon_active" + ipponList[side]["1"] + ".png" );
        }
        else
        {
            changeImage( side + "Ippon1ImageFlag", "ippon_activexx.png" );
        }

        if ( ipponList[side]["2"] < 21 )
        {
            changeImage( side + "Ippon2ImageFlag", "ippon_active" + ipponList[side]["2"] + ".png" );
        }
        else
        {
            changeImage( side + "Ippon2ImageFlag", "ippon_activexx.png" );
        }

        if ( ipponList[side]["3"] < 21 )
        {
            changeImage( side + "Ippon3ImageFlag", "ippon_active" + ipponList[side]["3"] + ".png" );
        }
        else
        {
            changeImage( side + "Ippon3ImageFlag", "ippon_activexx.png" );
        }
    ...
    if ( ipponList[side][ippon] == 0 )
    {
        document.getElementById( side + "Ippon" + ippon + "TDFlag" ).style.backgroundColor = "#000000";
    }
}
...
function increaseShido( side )
{
    ...
    if ( penaltyList[side]["shido"] < 21 )
    {
        changeImage( side + "ShidoImageFlag", "ippon_active" + penaltyList[side]["shido"] + ".png" );
    }
    else
    {
        changeImage( side + "ShidoImageFlag", "ippon_activexx.png" );
    }
...
function increaseChui( side )
{
    ...
    changeImage( side + "ChuiImageFlag", "ippon_active" + penaltyList[side]["chui"] + ".png" );
    if ( "left" == side )
    {
...
function increaseHansokumake( side )
{
    ...
    changeImage( side + penaltyOrder[3] + "ImageFlag", "blinker.gif" );
...
function decreaseHansokumake( side )
{
    ...
    if ( penalties[side][penaltyOrder[3]] )
    {
        ...
        changeImage( side + penaltyOrder[3] + "ImageFlag", "penalty_inactive.png" );
...
//========================================================================================
// Anzeigenwechsel Aufruf - 2007 by Sebastian Dressel
//========================================================================================
...
function handleAnzeige( displayForm )
{
    ...
    else
    {
        ...
        document.getElementById( "preparationfield" ).style.display = "none";
        //
		// individuelle Breite der Anzeige fuer TIME beruecksichtigen 2011 by SD
		document.getElementById("time_frame").style.left = ((window.innerWidth /2) - 80);
		//       
...
document.onmousemove = updateInfo;  				// 2007 by Sebastian Dressel
