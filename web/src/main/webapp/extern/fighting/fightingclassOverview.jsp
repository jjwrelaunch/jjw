...
<f:verbatim>
  ...
  <script type="text/javascript">
    $( document ).ready( function()
    {
      ...
      highlight( "<h:outputText value="#{adminFightingclassOverviewAction.sortColumn}"/>" );
...
<h:form id="adminFightingclassOverviewAction">
  ...
  <c:if test="${adminFightingclassOverviewAction.deleteStopFightingclasses != null}">

    <c:if test="${fn:length(adminFightingclassOverviewAction.deleteStopFightingclasses) > 0}">
      ...
      <t:dataTable sortColumn="#{adminFightingclassOverviewAction.sortColumn}"
                   value="#{adminFightingclassOverviewAction.deleteStopFightingclasses}" var="cty" border="0" cellspacing="0"
                   cellpadding="0" styleClass="fancyTable" rowClasses="odd,even" width="400px" id="fightingClassTable"
                   forceId="true" binding="#{adminFightingclassOverviewAction.dataTable}" align="center">
