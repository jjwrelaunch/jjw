    ...
    <tr>
      <td>
        <h:commandButton value="#{msg['fightingclassButton']}"
                         action="#{adminNewaclassAction.createFightingclass}"
                         id="createFightingclass" tabindex="1"/>
      </td>
    </tr>
  </table>
  
  <t:htmlTag value="h3"><h:outputText value="#{msg['fightingclassSuccess']}" rendered="#{adminNewaclassAction.createSuccessfull}"/></t:htmlTag>
</h:form>