...
<h:form id="adminNewaClockAction">
<f:loadBundle basename="de.jjw.webapp.messages.admin.fight" var="msg"/>

<html>
<head>
 <title>
    <h:outputText value="#{adminNewaClockAction.fight.newaclass.age.description}"/>
    &nbsp;
    <h:outputText value="#{adminNewaClockAction.fight.newaclass.sexWeb}"/>
    &nbsp;
    <h:outputText value="#{adminNewaClockAction.fight.newaclass.weightclass}"/></title>
...
<body oncontextmenu="return false" onLoad='startfight(
		paraAgeDescription,
		<h:outputText value="#{adminNewaClockAction.fight.newaclass.age.fightingTimeNewa}"/>,
		 <h:outputText value="#{adminNewaClockAction.fight.newaclass.age.overtime}"/>,
		15, 
		<h:outputText value="#{adminNewaClockAction.fight.newaclass.age.injurytime}"/>); 'onunload="shutClock();" >
...
<div id="loadfield" style="width:100%; height:100%; display:block; background-color:#ffffff; padding:0px; margin:0px;"
  ...
  <div style="color:#FFFFFF; background-color:#666666;">
    ...
    <script
        language="javascript">showAK( '<h:outputText value="#{adminNewaClockAction.fight.newaclass.age.description}" />', '<h:outputText value="#{adminNewaClockAction.fight.newaclass.sexWeb}" />', '<h:outputText value="#{adminNewaClockAction.fight.newaclass.weightclass}" />' );</script>
  </div>

  <div id="call_red_1" align="center"
       style="height:170px; width:100%; background-image: url('<h:outputText value="#{adminNewaClockAction.imageCommandRedWithContext}"/>'); ;margin-right:20px;">
    <h:outputText value="#{adminNewaClockAction.fight.fighterRed.firstname}"/>
    <br/>
    <span  id="call_red_1_name" style="font-size:100px;"><h:outputText value="#{adminNewaClockAction.fight.fighterRed.name}"/></span>
  </div>

  <hr/>

  <div id="call_blue_1" align="center"
       style="height:170px; width:100%; background-image: url('<h:outputText value="#{adminNewaClockAction.imageCommandBlueWithContext}"/>'); ;margin-right:20px;">
    <h:outputText value="#{adminNewaClockAction.fight.fighterBlue.firstname}"/>
    <br/>
    <span  id="call_blue_1_name" style="font-size:100px;"><h:outputText value="#{adminNewaClockAction.fight.fighterBlue.name}"/></span>
  </div>

  <hr/>

  <div style="display:block; overflow:hidden; width:100%; height:131px;">
   <t:dataTable value="#{adminNewaClockAction.previewForTatami}" var="cty" rows="1"
                   border="0" cellspacing="0" cellpadding="0" binding="#{adminNewaClockAction.dataTable}"  >
...
<div id="preparationfield"
  ...
  <div id="call_red_2" align="center" style="height:593px; width:100%; display:block; overflow:hidden; font-size:42px;">
    <t:dataTable value="#{adminNewaClockAction.previewForTatami}" var="cty2" rows="3"
                   border="0" cellspacing="0" cellpadding="0" binding="#{adminNewaClockAction.dataTable2}"  >
        <t:column width="40%" styleClass="font_red td_preparation"  style="font-size:50px !important;">          
        ...
        <tr>
          <td id="redNameTd" height="80" style="padding-left:10px;" valign="top"  colspan="5" >
            <span id="redSpanName" class="VornameWhite">
              <h:outputText value="#{adminNewaClockAction.fight.fighterRed.firstname}"/>&nbsp;<h:outputText  value="#{adminNewaClockAction.fight.fighterRed.name}"/>   </span>
            <br clear="all"/>
             <span  id="redSpanTeam" class="Verein">
              <h:outputText value="#{adminNewaClockAction.fight.fighterRed.team.teamName}"/> </span>
          </td>
        </tr>
        <tr>
          ...
          <tr>
            <td >
              <a href="#" onClick="resetClock('right')"><t:graphicImage value="#{adminNewaClockAction.imageCommandRed}" id="rightFlag" height="100" width="100" style="border:3px solid white;" alt=""/></a>
            </td>
          </tr>
           <tr>
        ...
        <tr>
          <td id="blueNameTd" height="80" style="padding-left:10px;" valign="top"  colspan="5" >
            <span id="blueSpanName" class="VornameWhite">
              <h:outputText value="#{adminNewaClockAction.fight.fighterBlue.firstname}"/>&nbsp;<h:outputText
            value="#{adminNewaClockAction.fight.fighterBlue.name}"/>   </span>
            <br clear="all"/>
             <span id="blueSpanTeam" class="Verein">
              <h:outputText value="#{adminNewaClockAction.fight.fighterBlue.team.teamName}"/> </span>
          </td>
        </tr>
        <tr>
          <td width="120" valign="top">
          ...
          <tr>
            <td>
              <a href="#" onClick="resetClock('left')"><t:graphicImage value="#{adminNewaClockAction.imageCommandBlue}" id="leftFlag" height="100" width="100" style="border:3px solid white;" alt=""/></a>
            </td>
          </tr>
           <tr>
...
<td  width="243px" align="right" valign="bottom" bgcolor="black"> <!--width="34%"-->
  ...
  <table cellpadding="4" cellspacing="0">                     <!-- Rahmen außen rechte Uhr Holding -->
    <tr>
      <td >                                   <!-- Rahmen außen rechte Uhr Holding -->
		 ...
		 <c:if test="${fn:length(adminNewaClockAction.previewForTatami) > 0}">
		 <t:dataTable value="#{adminNewaClockAction.previewForTatami}" var="cty3" rows="1"
                   border="0" cellspacing="0" cellpadding="0" binding="#{adminNewaClockAction.dataTable3}"  >
