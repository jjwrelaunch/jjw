...
<f:verbatim>
  ...
  <script type="text/javascript">
    $( document ).ready( function()
    {
      ...
      {
        $( "#FighterExportTable > tbody > tr" ).separator( function()
        {
  ...
  <c:if test="${adminShowNewaFighterAction.fighters != null}">
    <c:if test="${fn:length(adminShowNewaFighterAction.fighters) > 0}">
      ...
      <t:dataTable sortColumn="#{adminShowNewaFighterAction.sortColumn}"
                   ...
                   cellspacing="0" cellpadding="0" id="FighterExportTable" forceId="true"
        ...
        <t:column sortable="true" styleClass="center">
					...
					<h:selectBooleanCheckbox onchange="submit()"
						...
						valueChangeListener="#{adminShowNewaFighterAction.toggleMarkForExportListener}" />
				</t:column>
      </t:dataTable>
    </c:if>
  </c:if>
