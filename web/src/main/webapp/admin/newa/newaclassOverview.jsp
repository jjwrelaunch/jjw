...
<f:verbatim>
  ...
  <script type="text/javascript">
    $( document ).ready( function()
    {
      ...
      highlight( "<t:outputText value="#{adminNewaclassOverviewAction.sortColumn}"/>" );
...
<h:form id="adminNewaclassOverviewAction">
  ...
  <c:if test="${adminNewaclassOverviewAction.fighters != null}">

    <c:if test="${fn:length(adminNewaclassOverviewAction.fighters) > 0}">
      ...
      <t:dataTable sortColumn="#{adminNewaclassOverviewAction.sortColumn}"
                   value="#{adminNewaclassOverviewAction.fighters}" var="cty" border="0" width="800px"
                   cellspacing="0" cellpadding="0" styleClass="fancyTable" rowClasses="odd,even"
                   id="fightingClassTable" forceId="true" binding="#{adminNewaclassOverviewAction.dataTable}">
        ...
        <t:column sortable="true">
          ...
          <h:selectBooleanCheckbox onchange="submit()" value="#{cty.deleteStop}"
                                   valueChangeListener="#{adminNewaclassOverviewAction.toggleDeleteStopListener}"/>
        </t:column>
        <t:column sortable="true">
          <f:facet name="header">
          ...
          <h:selectBooleanCheckbox onchange="submit()" value="#{cty.complete}"
                                   valueChangeListener="#{adminNewaclassOverviewAction.toggleCompleteListener}"/>
        </t:column>
        <t:column sortable="true" styleClass="center">
          ...
          <h:commandLink action="#{adminNewaclassOverviewAction.printCertifications}">
