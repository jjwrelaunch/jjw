...
<%--
  ...
  ~
  ~ File    : automaticNewaWeightclass.jsp
  ~ Created : 05 Jun 2010
...
<h:form id="adminNewaWeightclassAction">
  <h:inputHidden id="id" value="" binding="#{adminNewaWeightclassAction.id}"/>
  <h:panelGrid columns="3">

    <h:outputLabel for="automaticAge" value="#{msg['weightclassAge']}"/>
    <h:outputText value="&nbsp;" escape="false"/>
    <h:selectOneMenu id="automaticAge" value="#{adminNewaWeightclassAction.automaticAge}" required="false" tabindex="1"
                     converter="jjw.webapp.converter.AgeConverter">
      <f:selectItems value="#{adminNewaWeightclassAction.agesForAutomaticFightingclassCreation}"/>
    </h:selectOneMenu><jjw:codestableErrorMark field="automaticAge"/>

    <h:commandButton value="#{msg['edit']}" action="#{adminNewaWeightclassAction.autoWeightclass}" id="autoWeightclass"
                     tabindex="6"/>
    <h:outputText value="&nbsp;" escape="false"/>
