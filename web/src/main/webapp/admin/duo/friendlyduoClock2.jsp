...
<h:form id="adminFriendlyDuoClockAction">
...
<title><h:outputText value="#{adminFriendlyDuoClockAction.fight.duoclass}"/></title>
</head>
 <script>
     isfriend=true;
</script>
<body oncontextmenu="return false" onLoad='startfight("friendly",    
    0,
	0,
	15, 
	120); 'onunload="shutFriendlyClock();" >
...
<div id="loadfield" style="width:100%; height:100%; display:block; background-color:#ffffff; padding:0px; margin:0px;"
  ...
  <script
      language="javascript">showAK( '<h:outputText value="#{adminFriendlyDuoClockAction.fight.duoclass.duoclassName}" />' );</script>

  <div id="call_red_1" align="center"
       style="background-image: url('<h:outputText value="#{adminFriendlyDuoClockAction.imageCommandRedWithContext}"/>');margin-right:20px">
    <h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamRed.firstname}"/>
    <h:outputText value="&nbsp;/&nbsp;" escape="false"/>
    <h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamRed.firstname2}"/>
    <br/>
    <span id="call_red_1_name" class="call_red_name">
      <h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamRed.name}"/>
      <h:outputText value="&nbsp;/&nbsp;" escape="false"/>
      <h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamRed.name2}"/>
    </span>
  </div>
  ...
  <div id="call_blue" align="center"
       style="background-image: url('<h:outputText value="#{adminFriendlyDuoClockAction.imageCommandBlueWithContext}"/>'); margin-right:20px">
    <h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamBlue.firstname}"/>
    <h:outputText value="&nbsp;/&nbsp;" escape="false"/>
    <h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamBlue.firstname2}"/>
    <br/>
    <span id="call_blue_1_name"  class="call_blue_name">
      <h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamBlue.name}"/>
      <h:outputText value="&nbsp;/&nbsp;" escape="false"/>
      <h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamBlue.name2}"/>
    </span>
  </div>
  <hr/>

  <div style="display:block; overflow:hidden; width:100%; height:131px;">
    <t:dataTable value="#{adminFriendlyDuoClockAction.previewForTatami}" var="cty" rows="1"
                   border="0" cellspacing="0" cellpadding="0" binding="#{adminFriendlyDuoClockAction.dataTable}"  >
...
<div id="preparationfield"
  ...
  <div id="call_red_2" align="center" style="height:593px; width:100%; display:block; overflow:hidden; font-size:42px;">
    <t:dataTable value="#{adminFriendlyDuoClockAction.previewForTatami}" var="cty2" rows="3"
                   border="0" cellspacing="0" cellpadding="0" binding="#{adminFriendlyDuoClockAction.dataTable2}"  >
        <t:column width="40%" styleClass="font_red td_preparation"  style="font-size:50px !important;">          
        ...
        <tr>
          <td id="tdNameRed" height="100" style="padding-left:10px;" valign="top"  colspan="6" >
            <span id="redSpanName" class="VornameWhite">
              <h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamRed.firstname}"/>&nbsp;<h:outputText
            value="#{adminFriendlyDuoClockAction.fight.duoTeamRed.name}"/> / 
            <h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamRed.firstname2}"/>&nbsp;<h:outputText
            value="#{adminFriendlyDuoClockAction.fight.duoTeamRed.name2}"/>   </span>
            <br clear="all"/>
             <span id="redSpanTeam" class="Verein"><h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamRed.team.teamName}"/> </span>
          </td>
        </tr>
        <tr>
          <td width="390"  >
          <table>
			  <td>
				  <table>
					  <tr>
						<td><t:graphicImage value="#{adminFriendlyDuoClockAction.imageCommandRed}" id="rightFlag" height="100" width="100" style="border:3px solid white;" alt=""/>						  
						</td> 
					  </tr>
					  <tr>
						<td valign="bottom" >
...
<table bgcolor="blue" width="100%" >
     <td valign="top" >
        ...
        <tr>
          <td id="tdNameBlue" height="100" style="padding-left:10px;" valign="top"  colspan="6" >
            <span id="blueSpanName" class="VornameWhite"><h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamBlue.firstname}"/>&nbsp;<h:outputText
            value="#{adminFriendlyDuoClockAction.fight.duoTeamBlue.name}"/>   / 
              <h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamBlue.firstname2}"/>&nbsp;<h:outputText
            value="#{adminFriendlyDuoClockAction.fight.duoTeamBlue.name2}"/>   </span>
            <br clear="all"/>
             <span id="blueSpanTeam" class="Verein"><h:outputText value="#{adminFriendlyDuoClockAction.fight.duoTeamBlue.team.teamName}"/> </span>
          </td>
        </tr>
        <tr>
          <td width="390">
          <table>
			<td>
				  <table>
					  <tr>
						<td><t:graphicImage value="#{adminFriendlyDuoClockAction.imageCommandBlue}" id="leftFlag" height="100" width="100" style="border:3px solid white;" alt=""/></td>
					  </tr>
					  <tr>
						<td valign="bottom" >
 ...
 <div id="rightInjuryClock" style="display:none; position:absolute; z-index:99; top:444px; left:146px; background: #000000;"   >
<table class="injury-border">
 ...
 <div id="leftInjuryClock" style="display:none; position:absolute; z-index:99; top:144px; left:146px; background-color: #000000;">
 <table class="injury-border">
	<td>
		 <table  cellspacing="0" cellpadding="0">
		 <tr >
...
<div id="duoClocks"
     style="display:block; position:absolute; z-index:100; left:0px; top:580px; width:100%; height:auto; visibility:hidden; background-color:#FFFFFF; margin:0px;">
<table width="100%">
<tr>                                                              <!-- unterer Bereich mit den Uhren -->
<td>
<table width="100%" border="0" cellspacing="0" cellpadding="0"> <!-- Uhrentabelle -->
<tr>
<td bgcolor="black" width="34%" valign="top" algin="left">
...
<td bgcolor="black" width="35%" align="right" valign="top">
