...
<%--
  ...
  ~
  ~ File    : showFriendlyDuoOpponent.jsp
  ~ Created : 17 Jun 2010
...
<t:htmlTag value="h3"><h:outputText value="#{msg['friendlyDuoOpponentHeadline'] }"/></t:htmlTag>
    ...
    <c:if test="${fn:length(adminShowFriendlyFighterAction.duoTeams) > 0}">
      ...
      <t:dataTable sortColumn="#{adminShowFriendlyFighterAction.sortColumn}" value="#{adminShowFriendlyFighterAction.duoTeams}"
        ...
        <t:column sortable="true" defaultSorted="true">
          ...
          <h:commandLink action="#{adminShowFriendlyFighterAction.submitDuoOpponent}">
            <h:outputText value="#{cty.name}"/>
             <f:param id="id" name="id" value="#{adminShowFriendlyFighterAction.duoTeam.id}"/>
          </h:commandLink>
        </t:column>
