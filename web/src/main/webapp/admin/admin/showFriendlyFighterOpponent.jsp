...
<t:htmlTag value="h3"><h:outputText value="#{msg['friendlyFighterOpponentHeadline'] }"/></t:htmlTag>
    ...
    <c:if test="${fn:length(adminShowFriendlyFighterAction.fighters) > 0}">
      ...
      <t:dataTable sortColumn="#{adminShowFriendlyFighterAction.sortColumn}"
        ...
        <t:column sortable="true" defaultSorted="true">
          ...
          <h:commandLink action="#{adminShowFriendlyFighterAction.submitOpponent}">
            <h:outputText value="#{cty.name}"/>
            <f:param id="id" name="id" value="#{adminShowFriendlyFighterAction.fighter.id}"/>
          </h:commandLink>
        </t:column>
