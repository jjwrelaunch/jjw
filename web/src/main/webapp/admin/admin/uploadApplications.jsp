...
<t:htmlTag value="h3"><h:outputText value="#{msg['uploadHeadline']}"/></t:htmlTag>
<h:form id="adminUploadTeamAction" enctype="multipart/form-data">
  ...
  <t:panelGrid columns="3">
     ...
     <t:dataTable 
      ...
      <h:commandButton value="#{msg['admin.teamEdit']}" action="#{adminUploadTeamAction.saveTeam}" id="addTeam" tabindex="17"
                         onclick="if(myevent !=true) document.getElementById('main:adminUploadTeamAction:change').value= '';"/>
