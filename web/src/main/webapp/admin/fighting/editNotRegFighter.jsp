  ...
  <t:panelGrid columns="2">
      ...
      <h:outputText value="&nbsp;" escape="false"/>
        ...
        <h:commandButton value="#{msg['edit']}"
                         ...
                         action="#{adminFighterAction.editNotRegFighter}" id="editFighter" tabindex="10"/>
       
      
      <h:commandButton value="#{msg['abort']}" action="#{adminFighterAction.gotoNotRegFighter}" id="gotoAllFighter"
                           tabindex="11"/>
