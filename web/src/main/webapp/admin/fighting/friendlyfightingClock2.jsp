...
<h:form id="adminFriendlyFightingClockAction">
...
<div id="loadfield" style="width:100%; height:100%; display:block; background-color:#ffffff; padding:0px; margin:0px;"
  ...
  <div id="call_red_1" align="center"
       style="height:170px; width:100%; background-image: url('<h:outputText value="#{adminFriendlyFightingClockAction.imageCommandRedWithContext}"/>'); ;margin-right:20px;">
    <h:outputText value="#{adminFriendlyFightingClockAction.fight.fighterRed.firstname}"/>
    <br/>
    <span  id="call_red_1_name" style="font-size:100px;"><h:outputText value="#{adminFriendlyFightingClockAction.fight.fighterRed.name}"/></span>
  </div>

  <hr/>

  <div id="call_blue_1" align="center"
       style="height:170px; width:100%; background-image: url('<h:outputText value="#{adminFriendlyFightingClockAction.imageCommandBlueWithContext}"/>'); ;margin-right:20px;">
    <h:outputText value="#{adminFriendlyFightingClockAction.fight.fighterBlue.firstname}"/>
    <br/>
    <span  id="call_blue_1_name" style="font-size:100px;"><h:outputText value="#{adminFriendlyFightingClockAction.fight.fighterBlue.name}"/></span>
  </div>

  <hr/>

  <div style="display:block; overflow:hidden; width:100%; height:131px;">
   <t:dataTable value="#{adminFriendlyFightingClockAction.previewForTatami}" var="cty" rows="1"
                   border="0" cellspacing="0" cellpadding="0" binding="#{adminFriendlyFightingClockAction.dataTable}"  >
...
<div id="preparationfield"
  ...
  <div id="call_red_2" align="center" style="height:593px; width:100%; display:block; overflow:hidden; font-size:42px;">
    <t:dataTable value="#{adminFriendlyFightingClockAction.previewForTatami}" var="cty2" rows="3"
                   border="0" cellspacing="0" cellpadding="0" binding="#{adminFriendlyFightingClockAction.dataTable2}"  >
        <t:column width="40%" styleClass="font_red td_preparation"  style="font-size:50px !important;">          
        ...
        <tr>
          <td id="redNameTd" height="80" style="padding-left:10px;" valign="top"  colspan="5" >
            <span id="redSpanName" class="VornameWhite">
              <h:outputText value="#{adminFriendlyFightingClockAction.fight.fighterRed.firstname}"/>&nbsp;<h:outputText  value="#{adminFriendlyFightingClockAction.fight.fighterRed.name}"/>   </span>
            <br clear="all"/>
             <span  id="redSpanTeam" class="Verein">
              <h:outputText value="#{adminFriendlyFightingClockAction.fight.fighterRed.team.teamName}"/> </span>
          </td>
        </tr>
        <tr>
          ...
          <tr>
            <td >
              <a href="#" onClick="resetClock('right')"><t:graphicImage value="#{adminFriendlyFightingClockAction.imageCommandRed}" id="rightFlag" height="100" width="100" style="border:3px solid white;" alt=""/></a>
            </td>
          </tr>
           <tr>
...
<table bgcolor="blue" width="100%" >
     <td valign="top" >
        ...
        <tr>
          ...
          <tr>
            <td>
              <a href="#" onClick="resetClock('left')"><t:graphicImage value="#{adminFriendlyFightingClockAction.imageCommandBlue}" id="leftFlag" height="100" width="100" style="border:3px solid white;" alt=""/></a>
            </td>
          </tr>
           <tr>
