 ...
 *
 * File    : jquery.tablesorter.pack.js
 * Created : 15 Jun 2010
...
(function( $ )
{
    $.extend( {tablesorter:new function()
    {
        var parsers = [],widgets = [];
        this.defaults =
        {cssHeader:"header",cssAsc:"headerSortUp",cssDesc:"headerSortDown",sortInitialOrder:"asc",sortMultiSortKey:"shiftKey",sortForce:null,sortAppend:null,textExtraction:"simple",parsers:{},widgets:[],widgetZebra:{css:["even","odd"]},headers:{},widthFixed:false,cancelSelection:true,sortList:[],headerList:[],dateFormat:"us",decimal:'.',debug:false};
        ...
        function buildCache( table )
        {
            ...
            var totalRows = (table.tBodies[0] && table.tBodies[0].rows.length) ||
                    ...
                    0,parsers = table.config.parsers,cache = {row:[],normalized:[]};
        ...
        function appendToTable( table, cache )
        {
            ...
            var c = cache,r = c.row,n = c.normalized,totalRows = n.length,checkCell = (n[0].length -
        ...
        function multisort( table, sortList, cache )
        {
            ...
            for ( var i = 0; i < l; i++ )
            {
                ...
                var s = (getCachedSortType( table.config.parsers, c ) == "text") ? ((order ==
                        0) ? "sortText" : "sortTextDesc") : ((order == 0) ? "sortNumeric" : "sortNumericDesc");
                var e = "e" + i;
