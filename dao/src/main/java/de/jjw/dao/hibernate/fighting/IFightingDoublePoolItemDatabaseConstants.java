 ...
 *
 * File    : IFightingDoublePoolItemDatabaseConstants.java
 * Created : 05 Jun 2010
...
public interface IFightingDoublePoolItemDatabaseConstants
{

    String TABLE_FIGHTING_DOUBLE_POOL = "FightingDoublePoolItem";
    String SQL_TABLE_FIGHTING_DOUBLE_POOL = "fighting_d_poolentries";
