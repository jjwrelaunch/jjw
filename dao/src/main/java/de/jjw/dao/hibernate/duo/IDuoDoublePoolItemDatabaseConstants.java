 ...
 *
 * File    : IDuoDoublePoolItemDatabaseConstants.java
 * Created : 05 Jun 2010
...
public interface IDuoDoublePoolItemDatabaseConstants
{

    String TABLE_DUO_DOUBLE_POOL = "DuoDoublePoolItem";
    String SQL_TABLE_DUO_DOUBLE_POOL = "duo_d_poolentries";
    String DUOCLASS_ID = "duoclassId";
    String DUOCLASS = "duoclass";
    String DUOTEAM = "duoTeam";
    String DUOTEAM_ID = "duoTeamId";
