 ...
 *
 * File    : IAgeDatabaseConstants.java
 * Created : 05 Jun 2010
...
public interface IAgeDatabaseConstants
    extends IBaseDatabaseConstants
{

    String TABLE_AGE = "Age";
    String SQL_TABLE_AGE = "age";
    String AGE_SHORT = "ageShort";
    String DESCRIPTION = "description";
    String FIGHTING_TIME = "fightingTime";
    String FIGHTING_ROUNDS = "fightingRounds";
    String START_AGE = "startAge";
    String AGE_LIMIT = "ageLimit";
