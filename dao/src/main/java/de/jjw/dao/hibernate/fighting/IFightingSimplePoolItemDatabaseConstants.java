 ...
 *
 * File    : IFightingSimplePoolItemDatabaseConstants.java
 * Created : 05 Jun 2010
...
public interface IFightingSimplePoolItemDatabaseConstants
    extends IBaseDatabaseConstants
{

    String TABLE_FIGHTING_SIMPLE_POOL = "FightingSimplePoolItem";
    String SQL_TABLE_FIGHTING_SIMPLE_POOL = "fighting_poolentries";
