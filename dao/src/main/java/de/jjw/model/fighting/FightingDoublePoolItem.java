 ...
 *
 * File    : FightingDoublePoolItem.java
 * Created : 05 Jun 2010
...
/**
 * @hibernate.class table="fighting_d_poolentries"
 */
public class FightingDoublePoolItem
    extends BaseObject
{
     ...
     * @hibernate.many-to-one class="de.jjw.model.fighting.Fight" column="finalFight"
     */
