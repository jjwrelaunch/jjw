...
/**
 * @author joerg.boehme
 * @hibernate.class table="newa_fighter"
 */
public class NewaFighter
    extends BaseObject
    implements Serializable
{
    ...
    /**
     * @return Returns the newaclass
     * @hibernate.many-to-one class="de.jjw.model.newa.Newaclass" column="newaclass" update="false" insert="false"
     */
    ...
    public boolean equals( Object o )
    {
        try
        {
            ...
            NewaFighter fighter = (NewaFighter) o;
            if ( this.getAge().equals( fighter.getAge() ) && this.getFirstname().equals( fighter.getFirstname() )
                ...
                && this.getWeight() == fighter.getWeight() && this.getNewaclass().equals( fighter.getNewaclass() )
    ...
    public boolean equalsIgnoreFighterName( Object o )
    {
        try
        {
            ...
            if ( this.getAge().equals( fighter.getAge() ) && this.getPlace() == fighter.getPlace()
                && this.getSex().equals( fighter.getSex() ) && this.getTeam().equals( fighter.getTeam() )
                && this.getWeight() == fighter.getWeight() && this.getNewaclassId() == fighter.getNewaclassId()
                && this.getReady().equals( fighter.getReady() ) && this.isDelete() == fighter.isDelete() )
            {
                return true;
            }
    ...
    /**
     * @param newaclassId
     * @hibernate.property column="newaclass"
     */
    ...
    /**
     * @param originalNewaclassId
     * @hibernate.property column="originalNewaclass"
     */
    public long getOriginalNewaclassId()
    {
        return originalNewaclassId;
	}

    public void setOriginalNewaclassId( long originalNewaclassId )
    {
        this.originalNewaclassId = originalNewaclassId;
	}
