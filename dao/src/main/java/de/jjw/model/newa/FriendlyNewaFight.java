...
/**
 * @hibernate.class table="newa_fight_list_friend"
 */
public class FriendlyNewaFight
extends BaseObject
{
    ...
    protected NewaFighter fighterRed;

    protected NewaFighter fighterBlue;

    protected Newaclass newaclass;

    protected Long newaclassId = TypeUtil.LONG_MIN;
     ...
     */
    public NewaFighter getFighterRed()
    {
        return fighterRed;
    }
     ...
     */
    public void setFighterRed( NewaFighter fighterRed )
    {
     ...
     * @return the fighterBlue
     */
    public NewaFighter getFighterBlue()
    {
        return fighterBlue;
    }
     ...
     */
    public void setFighterBlue( NewaFighter fighterBlue )
    {
     ...
     * @hibernate.many-to-one not-null="true" class="de.jjw.model.newa.Newaclass" column="newaclass" insert="false"
     *                        update="false"
     */
