...
/**
 * @hibernate.class table="duo_poolentries"
 */
public class DuoSimplePoolItem
    extends BaseObject
    implements Comparable
{
    ...
    private DuoSimplePoolItemResult result = new DuoSimplePoolItemResult();
    ...
    public DuoSimplePoolItemResult getResult()
    {
        return result;
    }

    public void setResult( DuoSimplePoolItemResult result )
    {
        this.result = result;
    }
    ...
    public int compareTo( Object o )
    {
        ...
        DuoSimplePoolItem item = (DuoSimplePoolItem) o;
