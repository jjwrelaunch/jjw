    ...
    implements IGlobalProjectConstants
{
    ...
    public String getCertificationWeb()
    {
        if ( !complete )
        {
            return IMAGE_JJW_DIR + EMPTY_GIF;
        }
        else if ( !certificationPrint )
        {
            return IMAGE_JJW_DIR + CERTIFICATE_ICON;
        }
        else
        {
            return IMAGE_JJW_DIR + OK_RED_GIF;
        }
    }
    ...
    public void setEstimateTimeWeb( String estimateTimeWeb )
    {
        this.estimateTimeWeb = estimateTimeWeb;
    }
